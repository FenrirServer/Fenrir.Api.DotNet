...
namespace Fenrir.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeploymentListResponse")]
    public partial class DeploymentListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeploymentListResponse" /> class.
        /// </summary>
        /// <param name="deployments">A list of application deployments..</param>
        public DeploymentListResponse(List<Deployment> deployments = default(List<Deployment>))
        {
            this.Deployments = deployments;
        }

        /// <summary>
        /// A list of application deployments.
        /// </summary>
        /// <value>A list of application deployments.</value>
