...
namespace Fenrir.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MatchmakingQueueConfigurationTeamRule")]
    public partial class MatchmakingQueueConfigurationTeamRule : IValidatableObject
    {
        /// <summary>
        /// Team rule type.
        /// </summary>
        /// <value>Team rule type.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum TypeEnum
        {
            /// <summary>
            /// Enum Average for value: max_difference_between_value_average
            /// </summary>
            [EnumMember(Value = "max_difference_between_value_average")]
            Average = 1,

            /// <summary>
            /// Enum Sum for value: max_difference_between_value_sum
            /// </summary>
            [EnumMember(Value = "max_difference_between_value_sum")]
            Sum = 2
        }
        ...
        /// </summary>
        /// <value>Team rule type.</value>
        /// <example>max_difference_between_value_average</example>
        [DataMember(Name = "type", IsRequired = true, EmitDefaultValue = true)]
        public TypeEnum Type { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="MatchmakingQueueConfigurationTeamRule" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MatchmakingQueueConfigurationTeamRule() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MatchmakingQueueConfigurationTeamRule" /> class.
        /// </summary>
        /// <param name="differenceValue">A value difference. Must be specified if team rule checks difference between values..</param>
        /// <param name="propertyKey">Player property key. Must be specified if a rule is applied to player properties. (required).</param>
        /// <param name="type">Team rule type. (required).</param>
        public MatchmakingQueueConfigurationTeamRule(decimal differenceValue = default(decimal), string propertyKey = default(string), TypeEnum type = default(TypeEnum))
        {
            // to ensure "propertyKey" is required (not null)
            if (propertyKey == null)
            {
                throw new ArgumentNullException("propertyKey is a required property for MatchmakingQueueConfigurationTeamRule and cannot be null");
            }
        ...
        /// <summary>
        /// A value difference. Must be specified if team rule checks difference between values.
        /// </summary>
        /// <value>A value difference. Must be specified if team rule checks difference between values.</value>
        /// <example>20</example>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MatchmakingQueueConfigurationTeamRule {\n");
